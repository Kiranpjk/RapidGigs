...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { name: 'Twitter', href: 'https://twitter.com/rapidgig', icon: '🐦' },
    { name: 'LinkedIn', href: 'https://linkedin.com/company/rapidgig', icon: '💼' },
    { name: 'Instagram', href: 'https://instagram.com/rapidgig', icon: '📸' },
    { name: 'YouTube', href: 'https://youtube.com/rapidgig', icon: '📺' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white font-poppins">RapidGig</span>
            </Link>
            <p className="text-gray-400 mb-6 font-inter">
              Connecting talent with opportunities through video introductions. 
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 font-inter">
              © {currentYear} RapidGig. All rights reserved.
            </div>
