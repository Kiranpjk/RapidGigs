...
export const NEARBY_GIGS: Job[] = [
  { id: '1', title: 'React Frontend Dev', company: 'Acme Corp', location: 'Remote', type: 'Remote', pay: '₹2,500/hr', description: 'Develop responsive and interactive user interfaces using React and TypeScript for our new HR platform.', postedAgo: '', companyVideoUrl: 'https://example.com/company.mp4', freelancerVideoUrl: 'https://example.com/freelancer.mp4' },
  { id: '2', title: 'UI/UX Designer', company: 'Global Solutions', location: 'Hybrid (NYC)', type: 'Hybrid', pay: '₹2,900/hr', description: 'Design intuitive and visually appealing user experiences for our enterprise-grade applications.', postedAgo: '', companyVideoUrl: 'https://example.com/company.mp4' },
  { id: '3', title: 'Python Backend Dev', company: 'TechInnovate', location: 'On-site (SF)', type: 'On-site', pay: '₹3,300/hr', description: 'Build robust and scalable backend services using Python, Django, and PostgreSQL.', postedAgo: '' },
  { id: '4', title: 'Data Analyst Intern', company: 'Data Insights Ltd.', location: 'Remote', type: 'Remote', pay: '₹2,100/hr', description: 'Assist in collecting, cleaning, and analyzing large datasets to provide actionable business insights.', postedAgo: '' },
  { id: '5', title: 'Digital Marketing Spec.', company: 'Mars Digital', location: 'Hybrid (LA)', type: 'Hybrid', pay: '₹2,300/hr', description: 'Manage social media campaigns, SEO efforts, and content creation for various client projects.', postedAgo: '' },
  { id: '6', title: 'Mobile App Developer', company: 'Cube Corp', location: 'On-site (Austin)', type: 'On-site', pay: '₹3,200/hr', description: 'Develop and maintain native mobile applications for iOS and Android platforms.', postedAgo: '' },
];

export const ALL_JOBS: Job[] = [
    { id: '7', title: 'Junior React Developer', company: 'InnovateTech Solutions', location: 'Remote', type: 'Remote', pay: '₹2,100 - ₹2,900/hr', postedAgo: '2 hours ago', description: 'Seeking a motivated Junior React Developer to help build our next-generation platform. Experience with TypeScript and Tailwind CSS is a plus.', companyVideoUrl: 'https://example.com/company.mp4', freelancerVideoUrl: 'https://example.com/freelancer.mp4', likes: 12500, comments: 342, shares: 129, },
    { id: '8', title: 'UI/UX Design Intern', company: 'Creative Flow Studio', location: 'On-site, London', type: 'On-site', pay: '₹1,700 - ₹2,100/hr', postedAgo: '1 day ago', description: 'Join our design team to work on exciting projects, from wireframing to high-fidelity prototypes. A great opportunity to grow your portfolio.', companyVideoUrl: 'https://example.com/company.mp4', likes: 8900, comments: 210, shares: 98, },
    { id: '9', title: 'Data Science Assistant', company: 'Data Insight Corp', location: 'Hybrid, New York', type: 'Hybrid', pay: '₹2,500 - ₹3,300/hr', postedAgo: '3 days ago', description: 'We are looking for a Data Science Assistant to support our analytics team. Proficiency in Python (Pandas, NumPy) and SQL is required.', likes: 15200, comments: 480, shares: 250, },
    { id: '10', title: 'Entry-Level Game Tester', company: 'GameDev Studios', location: 'On-site, Austin', type: 'On-site', pay: '₹1,250 - ₹1,700/hr', postedAgo: '5 days ago', description: 'Passionate about gaming? Help us find and report bugs in our upcoming titles. Keen attention to detail is a must.' },
    { id: '11', title: 'Social Media Coordinator', company: 'Marketing Minds Inc.', location: 'Remote', type: 'Remote', pay: '₹1,850 - ₹2,350/hr', postedAgo: '1 week ago', description: 'Manage and grow our clients\' social media presence across various platforms. Experience with content creation and analytics tools is preferred.', likes: 7300, comments: 150, shares: 60, },
    { id: '12', title: 'Content Writer for E-Learning', company: 'EduTech Innovations', location: 'Remote', type: 'Remote', pay: '₹2,350 - ₹3,200/hr', postedAgo: '1 week ago', description: 'Create engaging and educational content for our online courses. A background in instructional design is highly desirable.' },
    { id: '13', title: 'Healthcare IT Support', company: 'HealthLink Services', location: 'On-site, Chicago', type: 'On-site', pay: '₹2,100 - ₹2,500/hr', postedAgo: '2 weeks ago', description: 'Provide technical support for our healthcare information systems. Strong problem-solving skills and a customer-centric attitude are essential.' },
    { id: '14', title: 'Junior Financial Analyst', company: 'FinServe Analytics', location: 'Hybrid, Toronto', type: 'Hybrid', pay: '₹2,500 - ₹3,750/hr', postedAgo: '3 weeks ago', description: 'Assist our finance team with data analysis, financial modeling, and reporting. A degree in Finance, Economics, or a related field is required.' },
    { id: '15', title: 'Cloud Infrastructure Intern', company: 'CloudOps Solutions', location: 'Remote', type: 'Remote', pay: '₹2,250 - ₹3,100/hr', postedAgo: '1 month ago', description: 'Gain hands-on experience with AWS, Docker, and Kubernetes. This internship offers a path to a full-time role for the right candidate.' },
    { id: '16', title: 'Automotive CAD Designer', company: 'AutoDesign Innovations', location: 'On-site, Detroit', type: 'On-site', pay: '₹2,900 - ₹4,200/hr', postedAgo: '1 month ago', description: 'Create and modify 3D models and 2D drawings for automotive components. Proficiency in CATIA or SolidWorks is a must.' },
    { id: '17', title: 'Renewable Energy Researcher', company: 'GreenEnergy Labs', location: 'On-site, San Francisco', type: 'On-site', pay: '₹3,300 - ₹4,600/hr', postedAgo: '2 months ago', description: 'Conduct research on solar and wind energy technologies. A Master\'s or PhD in a relevant engineering or science discipline is preferred.' },
    { id: '18', title: 'E-commerce Operations Assistant', company: 'FutureRetail Tech', location: 'Hybrid, Berlin', type: 'Hybrid', pay: '₹1,700 - ₹2,500/hr', postedAgo: '2 months ago', description: 'Support our e-commerce team with order management, inventory control, and customer service. Excellent organizational skills are key.' },
];
...
export const NOTIFICATIONS: Notification[] = [
    ...
    {id: '2', text: "RapidGig Platform maintenance scheduled for 2 AM UTC.", time: "1 hour ago"},
    {id: '3', text: "Your profile is 80% complete. Add a video intro!", time: "4 hours ago"},
    {id: '4', text: "New message from Jane Doe.", time: "Yesterday"},
    {id: '5', text: "New gig matching your skills: 'Mobile App Debugger'.", time: "2 days ago"},
];
