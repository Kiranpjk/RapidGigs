...
class VideoRequest(BaseModel):
    ...
    max_poll_attempts: int = Field(30, ge=1, le=60)  # Max polling attempts
    poll_wait_seconds: int = Field(5, ge=1, le=30)  # Seconds between polls
...
class VideoExtendRequest(BaseModel):
    ...
    auto_poll: bool = True
    max_poll_attempts: int = Field(30, ge=1, le=60)
